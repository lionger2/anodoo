...
class MailActivityType(models.Model):
    ...
    lifetime_id = fields.Many2one('anodoo.lead.lifetime', string='生命周期', help="活动和商机的阶段进行关联")
    
    stage_id = fields.Many2one('crm.stage', string="阶段", domain="[('lifetime_id','=', lifetime_id)]", help="针对商机特定阶段定义的活动")
